...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class GraphAuthenticationBot : IBot
    {
        ...
        private const string ConnectionSettingName = "cdw-basicbot-20190420-bot-auth";
        ...
        public async Task OnTurnAsync(ITurnContext turnContext, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            switch (turnContext.Activity.Type)
            {
                ...
                case ActivityTypes.Invoke:
                    ...
                    {
                        throw new InvalidOperationException("The Invoke type is only valid on the MSTeams channel.");
                    }
