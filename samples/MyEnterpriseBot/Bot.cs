...
using MyEnterpriseBot.Dialogs.Main;

namespace MyEnterpriseBot
{
    /// <summary>
    ...
    public class Bot : IBot
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MyEnterpriseBot"/> class.
        /// </summary>
        ...
        public Bot(BotServices botServices, ConversationState conversationState, UserState userState, IBotTelemetryClient telemetryClient)
        {
            ...
            _dialogs = new DialogSet(_conversationState.CreateProperty<DialogState>(nameof(MyEnterpriseBot)));
